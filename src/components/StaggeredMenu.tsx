...
.sm-scope .sm-socials { margin-top: auto; margin-bottom: 3rem; padding-top: 2rem; display: flex; flex-direction: column; gap: 0.75rem; }
...
.sm-scope .sm-socials-link { font-size: 1.2rem; font-weight: 600; color: #111; text-decoration: none; position: relative; padding: 2px 0; display: inline-block; transition: color 0.3s ease, opacity 0.3s ease; }
